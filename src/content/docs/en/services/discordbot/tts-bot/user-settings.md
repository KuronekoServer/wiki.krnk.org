...
-- | -- | --
/user-settings speed | Change your reading speed. | Same range as [/setspeed](/en/services/discordbot/tts-bot/voice-settings/)
/user-settings pitch | Change your reading pitch. | Same range as [/setpitch](/en/services/discordbot/tts-bot/voice-settings/)
/user-settings intonation | Change your intonation. | Same range as [/setintonation](/en/services/discordbot/tts-bot/voice-settings/)
/user-settings volume | Change your volume. | Same range as [/setvolume](/en/services/discordbot/tts-bot/voice-settings/)
