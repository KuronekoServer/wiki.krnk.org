...
명령어 | 설명 | 참고
-- | -- | --
/user-settings speed | 읽기 속도를 변경합니다. | [/setspeed](/ko/services/discordbot/tts-bot/voice-settings/) 와 같은 범위입니다.
/user-settings pitch | 읽기 피치를 변경합니다. | [/setpitch](/ko/services/discordbot/tts-bot/voice-settings/) 와 같은 범위입니다.
/user-settings intonation | 억양을 변경합니다. | [/setintonation](/ko/services/discordbot/tts-bot/voice-settings/) 와 같은 범위입니다.
/user-settings volume | 볼륨을 변경합니다. | [/setvolume](/ko/services/discordbot/tts-bot/voice-settings/) 와 같은 범위입니다.
...
## 관련 페이지
- [음성 설정 명령어](/ko/services/discordbot/tts-bot/voice-settings/)
