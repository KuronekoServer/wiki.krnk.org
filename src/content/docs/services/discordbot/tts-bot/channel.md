...
- BOTが未接続の場合は、実行者が参加しているVCへ接続してからカテゴリの読み上げを開始します。
...
/channel link remove | 既存のチャンネル紐付けを解除します。 | テキストチャンネルを省略した場合はVCの紐付けをまとめて解除します。
/channel link list | 登録済みのチャンネル紐付けを確認します。 | VCを指定すると、そのVCのみ確認できます。
...
## 関連ページ
- [接続コマンド](/services/discordbot/tts-bot/basic-commands/)
- [/server-settings](/services/discordbot/tts-bot/server-settings/)
