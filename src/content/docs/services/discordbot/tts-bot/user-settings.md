...
コマンド名 | 概要 | 補足
-- | -- | --
/user-settings speed | 読み上げ速度を変更します。 | [/setspeed](/services/discordbot/tts-bot/voice-settings/) と同じ範囲です。
/user-settings pitch | 読み上げピッチを変更します。 | [/setpitch](/services/discordbot/tts-bot/voice-settings/) と同じ範囲です。
/user-settings intonation | イントネーションを変更します。 | [/setintonation](/services/discordbot/tts-bot/voice-settings/) と同じ範囲です。
/user-settings volume | 音量を変更します。 | [/setvolume](/services/discordbot/tts-bot/voice-settings/) と同じ範囲です。
